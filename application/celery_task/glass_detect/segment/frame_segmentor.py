...
class FrameSegmentor(ImageSegmentor):
    def __init__(self, net: Optional[nn.Module] = None, device: str = "cpu"):
        ...
        if net is None:
            ...
            checkpoint_path = os.path.join(current_dir, "checkpoints", "frame.pth")
    ...
    def segment(
        ...
        default_properties = {
            "spacing": (999, 1, 1),
            "shape_before_cropping": (1, 1600, 3200),
            "bbox_used_for_cropping": [[0, 1], [0, 1600], [0, 3200]],
            "shape_after_cropping_and_before_resampling": (1, 1600, 3200),
        }
        properties = (
            default_properties
