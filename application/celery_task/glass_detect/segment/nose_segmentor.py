...
class NoseSegmentor(ImageSegmentor):
    ...
    def segment(
        ...
        patch_size: tuple = (1024, 1024),
        is_one: bool = True,
    ) -> np.ndarray:
        default_properties = {
            "spacing": (999, 1, 1),
            "shape_before_cropping": (1, 1024, 1024),
            "bbox_used_for_cropping": [[0, 1], [0, 1024], [0, 1024]],
            "shape_after_cropping_and_before_resampling": (1, 1024, 1024),
        }
        properties = (
            default_properties
