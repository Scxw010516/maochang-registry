...
from .method.balance_temple_light import balance_light_local
...
def ps_temple(image: dict, types: dict) -> np.ndarray:
    ...
    front_foreground = image["front_foreground"]
    front_mask = image["front_mask"]
    image_ps = balance_light_local(image_ps, mask, front_foreground, front_mask)
