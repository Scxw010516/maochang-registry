...
# 资源库
from application.maochang.models import *
from application.maochang.recommend import recommend
from application.maochang import services
...
def preview(request: HttpRequest):
	...
	# imgdata = base64.b64encode(buffer.getvalue()).decode("utf-8")
	# return JsonResponse(data={"result": f'data:image/jpeg;base64,' + imgdata})
