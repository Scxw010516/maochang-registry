  ...
  <a-layout v-if="store.state.hasLoggedIn" class="full-height-row">
          ...
          <a-col class="input-basic-form-card">
            ...
            >
              ...
              <div style="height: 550px; overflow: auto">
                ...
                <a-form-item label="透明" name="istransparent" class="basic-item">
                  <a-radio-group
                    v-model:value="EyeGlassBasicFormState.istransparent"
                    @keyup.enter="onClickEnterBasicParams"
                  >
                    <a-radio-button
                      :value="1"
    ...
    >
      ...
      >
        <!-- 拍摄 -->
        <a-row
          v-if="currentStage !== 'input-params'"
            ...
            <a-row>
              <a-col :span="8">
                <img
                  ...
                  :src="imgCameraPreview0Url"
                />
              </a-col>
              <a-col :span="8">
                <img
                  class="registry-preview-sub-image"
                  :src="imgCameraPreview1Url"
                />
              </a-col>
              <a-col :span="8">
                <img
                  class="registry-preview-sub-image"
                  :src="imgCameraPreview2Url"
                />
              </a-col>
            </a-row>
            <!-- 信息展示 -->
...
const saveNewEyeglassFrame = async () => {
  ...
  formData.append(
    "istransparent",
    EyeGlassBasicFormState.istransparent !== null
      ? EyeGlassBasicFormState.istransparent.toString()
      : "",
  );
  formData.append(
    "stock",
