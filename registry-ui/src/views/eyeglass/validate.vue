        ...
        >
          ...
          >
            ...
            >
              ...
              <a-collapse-panel
                key="1"
                :header="EyeGlassDetailFormLabelGroups.frontView.title"
                :style="customStyle"
              >
              ...
              <a-collapse-panel
                key="2"
                :header="EyeGlassDetailFormLabelGroups.sideView.title"
                :style="customStyle"
              >
                <a-row :gutter="[30, 30]" style="width: 880px">
                  <a-col
              ...
              <a-collapse-panel
                key="3"
                :header="EyeGlassDetailFormLabelGroups.topView.title"
                :style="customStyle"
              >
                <a-row :gutter="[30, 30]" style="width: 880px">
                  <a-col
